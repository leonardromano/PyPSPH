...
from src.parameters.Constants import BITS_FOR_POSITIONS, MAX_INT, TREE_NUM_BEFORE_NODESPLIT
...
def update_Tp(particles, NgbTree_ref, Problem):
    ...
    Tp_new = { particle.index: particle for particle in particles}
...
class ngbtree():
    ...
    def __init__(self, particles, Problem):
        ...
        self.Tp            = { particle.index: particle for particle in particles}
